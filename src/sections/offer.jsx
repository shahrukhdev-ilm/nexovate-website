...
export const Offer = () => {
  ...
  return (
    <div id='services' className='w-full h-auto flex flex-col items-center justify-center lg:px-[80px] py-[60px] gap-[20px]'>
      ...
      <h1 data-aos="zoom-in" data-aos-delay="100" className='text-white lg:text-[70px] text-[40px] capitalize font-poppins leading-[1.2em] font-poppins'>Driving Digital Transformation with Excellence</h1>
